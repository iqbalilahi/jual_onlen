    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>auth"><b>JUALAN ONLEN</b></a>
            </div>
            <!-- /.login-logo -->
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-xs-12">
                        <div class="callout callout-info">
                            ...
                            <p><b>Email</b> : iqbalilahi7@gmail.com</p>
                            <p><b>Password</b> : password</p>
                            <hr>
                            <h4>Level Customer</h4>

                            <p><b>Email</b> : gilangsugih19@gmail.com</p>
                            <p><b>Password</b> : password</p>
                        </div>
                    </div>
