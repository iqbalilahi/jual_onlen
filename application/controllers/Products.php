...
class Products extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            ...
            $config['first_url'] = base_url() . 'index.php/products/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/products/index/';
            $config['first_url'] = base_url() . 'index.php/products/index/';
        }
        ...
        $this->template->load('template','products/products_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'stock' => $row->stock,
            ...
            $this->template->load('template','products/products_read', $data);
        } else {
